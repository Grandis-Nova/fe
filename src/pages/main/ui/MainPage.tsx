...
export function MainPage() {
  ...
  const [recommendedStorageSelections, setRecommendedStorageSelections] = useState(() =>
    ...
    <>
      ...
      <div
        className={sprinkles({
          ...
          paddingY: { mobile: 20, desktop: 50 },
          maxWidth: { mobile: 'full', desktop: 'content' },
          marginX: 'auto',
        })}
      >
        <div className={styles.recommendedTitle}>추천 상품</div>
